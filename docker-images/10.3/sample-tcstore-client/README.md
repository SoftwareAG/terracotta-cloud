#What is the sample tcstore client ?
...
You can start it up simply with :
    ...
    docker run -e ACCEPT_EULA=Y --name client -d sample-tcstore-client:10.3.0-SNAPSHOT
...
and then re try running the client, with :
    ...
    docker run -e ACCEPT_EULA=Y -d --link terracotta:terracotta --name store-client sample-tcstore-client:10.3.0-SNAPSHOT
...
To build this Dockerfile
    ...
    $ docker build --file docker/images/sample-tcstore-client/Dockerfile --tag sample-tcstore-client:10.3.0-SNAPSHOT .